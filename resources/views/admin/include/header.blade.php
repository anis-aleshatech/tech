      ...
      <div class="navbar navbar-default">
        <div class="navbar-header">
          <a class="navbar-brand navbar-brand-center" href="{{route('home')}}" target="_blank" style="width:100%; padding:0; margin:0 0 20px 0; text-align:center;">
            <img class="" src="{{ asset('assets/front/images/logo.png') }}" alt="Alesha Tech Ltd." style="width:100px; height:auto; text-align:center; margin:auto 0 20px 0">
          </a>
          ...
          <button class="navbar-toggler visible-xs-block collapsed" type="button" data-toggle="collapse" data-target="#navbar">
            ...
            <span class="ellipsis ellipsis-vertical">            	
              @if(Auth::user()->photo!="")
                  ...
                  @else
                  	<img class="ellipsis-object" width="32" height="32" src="{{  asset('uploads/admin/user-placeholder.jpg') }}" 
                      alt="<?php echo Auth::user()->fullname;?>" style="float:left; margin-right:5px;">
                  @endif
            </span>
          </button>
            ...
            <nav id="sidenav" class="sidenav-collapse collapse">            
                  ...
                  <ul class="sidenav">
                    <li class="sidenav-heading">Administration</li>    
                       ...
                       <li class="sidenav-item has-subnav"><a href="#" aria-haspopup="true"><span class="sidenav-icon fa fa-map"></span><span class="sidenav-label">News & Events</span></a>
                          <ul class="sidenav-subnav collapse">
                            <li><a href="{{ route('blog.index')}}"><span class="sidenav-icon fa fa-bars"></span>Blog List</a></li>
                            <li><a href="{{ route('blog.create')}}"><span class="sidenav-icon fa fa-plus"></span>Add New Blog</a></li>
                          </ul>
                        </li>
                        ...
                        <li class="sidenav-item has-subnav"><a href="#" aria-haspopup="true"><span class="sidenav-icon fa fa-map"></span><span class="sidenav-label">Our Goal</span></a>
                          <ul class="sidenav-subnav collapse">
                            <li><a href="{{ route('goal.index')}}"><span class="sidenav-icon fa fa-bars"></span>Our Goal List</a></li>
                            <li><a href="{{ route('goal.create')}}"><span class="sidenav-icon fa fa-plus"></span>Add New Goal</a></li>
                          </ul>
                        </li>
                        ...
                        <li class="sidenav-item has-subnav"><a href="#" aria-haspopup="true"><span class="sidenav-icon fa fa-map"></span><span class="sidenav-label">Board of Director</span></a>
                          <ul class="sidenav-subnav collapse">
                            <li><a href="{{ route('director.index')}}"><span class="sidenav-icon fa fa-bars"></span>Director List</a></li>
                            <li><a href="{{ route('director.create')}}"><span class="sidenav-icon fa fa-plus"></span>Add New Director</a></li>
                          </ul>
                        </li>
                        ...
                        <span class="sidenav-icon fa fa-map"></span><span class="sidenav-label">Products List</span></a>
                          ...
                          <li class="sidenav-item has-subnav"><a href="#" aria-haspopup="true">
                        <span class="sidenav-icon fa fa-map"></span><span class="sidenav-label">Our Protfolio List</span></a>
                          <ul class="sidenav-subnav collapse">
