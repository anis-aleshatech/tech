@extends('admin.include.master') 
	@section('title') Contents - Alesha Tech Ltd. @endsection 
@section('content')
                  ...
                  <div class="card">
                      ...
                      <div class="card-block">
                       ...
                       <form id="form_check">
                            ...
                            <?php $i++; 
							//\App\Menu::where(['id' => $content->menu_id])->pluck('title')->first()
							$selectedMenu = \App\Models\Content::find($content->menu_id)->menus;
							if($selectedMenu!=""){
